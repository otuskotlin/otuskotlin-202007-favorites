...
import ru.otus.otuskotlin.favorites.backend.logics.handlers.stubGet
import ru.otus.otuskotlin.favorites.backend.logics.handlers.stubIndex
import ru.otus.otuskotlin.favorites.mp.cor.cor


class FavoritesItemIndexChain(
//        private val userRepoProd: IUserRepository,
//        private val userRepoTest: IUserRepository
) {

    suspend fun exec(context: FavoritesItemContext) = FavoritesItemIndexChain.chain.exec(context.apply {
...
//            }
            ...
            exec(stubIndex) // Обработка стабов
